...
- [x] 3.2 Crear `clients/python/` con cliente TCP, errores tipados y prueba de humo `pytest`.
- [x] 3.3 Añadir `tests/e2e/` para C# y Python sobre misma/distinta base; ejecutar la matriz macOS/Linux/Windows en CI.
...
- [x] 4.2 Registrar latencia, rendimiento, errores, entorno, límites y conclusión continuar/pivotar/detener en resultados reproducibles.
- [x] 4.3 Documentar `docs/protocolo-local.md`: mensajes, parámetros, errores, raíz de archivos, un escritor y límites del MVP.
